      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><a href="mailto:gunner.m.lee@gmail.com" className="text-sm text-gray-600 hover:text-primary">gunner.m.lee@gmail.com</a></li>
              <li><a href="tel:+15108286946" className="text-sm text-gray-600 hover:text-primary">(510) 828-6946</a></li>
            </ul>
          </div>
        </div>
        <div className="mt-8 pt-8 border-t border-gray-100 text-center">
          <p className="text-sm text-gray-500">© 2024 Gunner Lee. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
